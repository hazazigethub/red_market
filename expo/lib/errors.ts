const MAP: Record<string, string> = {
  ...
  PAYMENT_REQUIRED: "أدخل كود الدفع لإتمام المشاركة.",
  INVALID_CODE: "كود الدفع غير صالح أو منتهي.",
  CODE_NOT_FULL: "هذا الكود لا يغطي كامل رسوم المشاركة.",
  CODE_USED: "استخدمت هذا الكود من قبل.",
  ALREADY_JOINED: "أنت مشارك في هذا المعرض.",
